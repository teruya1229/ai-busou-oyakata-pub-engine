...
- **用途別コピー**（入力欄の直下）: **4コマ構成 / 4コマ統合プロンプト / Kindle節素材**を個別にコピー。**note を投稿する**ときは、出力の **note投稿用コピー**ブロックから **タイトル案／本文のみ／H1付き全文／投稿セット（タイトル案＋本文のみ）**を選ぶと分かりやすいです。**スタイル向けにまとめてコピー**は、出力スタイルに応じて **note向け＝本文のみ＋4コマ**、**4コマ向け＝構成＋統合**、**Kindle向け＝本文のみ＋節素材**、**未指定＝本文のみ＋4コマ＋統合**を `---` 区切りで連結します（先頭はタイトル案）。
