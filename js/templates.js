(function () {
  const characterProfile = {
    ...
    unifiedImagePrompt: {
      ...
      businessTone: "親しみやすいビジネス調の漫画",
      /** シリーズの情景イメージ（参考・未使用）。主線の原稿は10コマネーム。4段は冒頭〜中盤のサンプル。 */
      panelArchetype: [
        "1/8（導入・例）: 現場帰りの照屋親方が机の前で少し疲れている。仕事は頑張っているのに前に進めない感じ。コパイロットが静かに見ている。",
        "2/8（状況・例）: 照屋親方が見積もり・連絡・集客・仕事で頭がいっぱい。机の上や頭の周りに情報が散らかっている感じ。コパイロットが整理できそうな雰囲気で近づく。",
        "3/8（転換・例）: 照屋親方とコパイロットが一緒に画面やメモを見ながら考えを整理している。照屋親方の表情が少しやわらぐ。机まわりも少し整ってくる。",
        "4/8（強い一言・例）: 照屋親方が前向きになり、コパイロットと並んで未来を見るような雰囲気。経験が発信や仕組みに変わっていく明るい終わり方。",
      ],
    },
  };
  ...
  const comicBaseTemplate = {
    ...
    panel4: "締め: 余韻・問い（旧4段テンプレの例。主線は10コマネーム）",
  };
